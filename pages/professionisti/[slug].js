...
export default function ProfiloPersonalTrainer() {
  ...
  // Dati del trainer (in una app reale verrebbero da API)
  const trainer = {
    id: 1,
    nome: "Marco Rossi",
    ...
    galleria: [
      ...
      "https://images.unsplash.com/photo-1583500178690-f7e6a7c0ea54?w=300&h=200&fit=crop"
    ],
    disponibile: true,
    badge: "Top Rated",
    clientiSeguiti: 250,
  ...
  const programmi = [
    ...
    },
    {
      ...
      durata: "10 settimane",
      tipo: "Ebook PDF",
      immagine: "https://images.unsplash.com/photo-1583500178690-f7e6a7c0ea54?w=300&h=200&fit=crop"
    }
  ];
  ...
  const recensioniRecenti = [
    {
      ...
      rating: 5,
      data: "2 settimane fa",
      commento: "Marco è un professionista eccezionale. Grazie ai suoi programmi ho aumentato la mia forza del 40% in 6 mesi. Altamente raccomandato!",
      verificata: true
    },
    {
      id: 2,
      ...
      rating: 5,
      data: "1 mese fa",
      commento: "Approccio scientifico e personalizzato. Marco mi ha aiutata a raggiungere obiettivi che credevo impossibili. Professionalità al top!",
      verificata: true
    },
    {
      id: 3,
      ...
      rating: 4,
      data: "2 mesi fa",
      commento: "Ottimi programmi e supporto costante. L'unica pecca è che a volte risponde un po' tardi ai messaggi, ma ne vale la pena.",
      verificata: true
    }
  ];
        ...
        <div className="bg-gray-50 py-4">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex items-center space-x-2 text-sm">
              ...
              <Link href="/professionisti" className="text-gray-500 hover:text-blue-600">Professionisti</Link>
              <ChevronRight className="w-4 h-4 text-gray-400" />
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              <div className="md:flex">
                ...
                <div className="md:w-2/3 p-8">
                    ...
                    <div>
                      ...
                      <div className="flex items-center mb-4">
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="text-gray-700">{trainer.clientiSeguiti}+ clienti seguiti</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-gray-500">Tariffe</div>
                      <div className="text-2xl font-bold text-blue-600">{trainer.prezzo}</div>
                      <div className="text-sm text-gray-600">Consulenza: {trainer.prezzoConsulenza} • Sessione: {trainer.prezzoSessione}</div>
                    </div>
            ...
            {activeTab === 'overview' && (
              <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                  ...
                  <div className="bg-white rounded-xl shadow-sm border p-6">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      {trainer.galleria.map((img, index) => (
                        <img
                          key={index}
                          src={img}
                          alt={`Foto ${index + 1}`}
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <span className="text-gray-600">Clienti seguiti</span>
                        </div>
                        <span className="font-semibold">{trainer.clientiSeguiti}+</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                  ...
                  {/* Disponibilità */}
                  <div className="bg-white rounded-xl shadow-sm border p-6">
                    <h3 className="text-lg font-bold text-gray-900 mb-4">Orari Disponibili</h3>
                    <div className="space-y-2">
                      {trainer.orariDisponibili.map((orario, index) => (
                  ...
                  <div className="bg-blue-50 rounded-xl p-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-sm text-gray-700">Risposta entro 24h</span>
                      </div>
                      <div className="flex items-center">
                        <CheckCircle className="w-5 h-5 text-purple-600 mr-2" />
                        <span className="text-sm text-gray-700">Soddisfatti o rimborsati</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border p-8">
                  ...
                  <div className="mt-8 pt-6 border-t">
                    <div className="flex space-x-4">
                      ...
                      <button className="flex-1 border border-gray-300 text-gray-700 hover:bg-gray-50 py-3 rounded-lg font-medium transition-colors flex items-center justify-center">
                        <Calendar className="w-5 h-5 mr-2" />
                        Prenota Chiamata
                      </button>
                    </div>
        ...
        <section className="py-16 bg-gradient-to-r from-blue-600 to-blue-700">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">
              Pronto a Iniziare con {trainer.nome}? 💪
            </h2>
            <p className="text-xl text-blue-100 mb-8">
              Prenota una consulenza gratuita e scopri come raggiungere i tuoi obiettivi
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
              <button className="bg-white text-blue-600 hover:bg-gray-100 px-8 py-4 rounded-lg font-semibold transition-colors flex items-center">
                <Calendar className="w-5 h-5 mr-2" />
                Prenota Consulenza Gratuita
              </button>
              <button className="border-2 border-white text-white hover:bg-white hover:text-blue-600 px-8 py-4 rounded-lg font-semibold transition-colors flex items-center">
                <MessageCircle className="w-5 h-5 mr-2" />
                Contatta Ora
              </button>
            </div>
